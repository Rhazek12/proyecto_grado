...
class DiversidadSexual(models.Model):
    ...
    id_persona = models.OneToOneField(Persona, on_delete=models.CASCADE, null=False, blank=False, related_name="DiversidadSexual") 
...
class InformacionGeneral(models.Model):
    ...
    id_persona = models.OneToOneField(Persona, on_delete=models.CASCADE, null=False, blank=False, related_name="InformacionGeneral")
...
class InformacionAcademica(models.Model):
    ...
    id_persona = models.OneToOneField(Persona, on_delete=models.CASCADE, null=False, blank=False, related_name="InformacionAcademica")
...
class DocumentosAutorizacion(models.Model):
    ...
    id_persona = models.OneToOneField(Persona, on_delete=models.CASCADE, null=False, blank=False, related_name="DocumentosAutorizacion")
